...
from Lib_index import createNDVI, createNDVIMod, createTNDVI, createPNDVI, createNDWI, createNDWI2, createNDWI2Mod, createMNDWI, createISU, createGEMI, createBSI, createNDBI, createNBI, createIR, createCI, createBI
...
#    indices_to_compute_list : indicesToComputeList = ["NDVI","NDVImod","TNDVI","NDWI","ISU","GEMI"], defaut=[]
...
def extractTexture(image_input, repertory_neochannels_output, path_time_log, channels_list, texture_families_list, radius_list, indices_to_compute_list=[], channel_order=['Red','Green','Blue','NIR'], extension_raster=".tif", save_results_intermediate=False, overwrite=True, bin_number=64):
    ...
    channels_number_dico ={"Red":0,"Green":0,"Blue":0,"NIR":0,"RE":0,"MIR":0}
